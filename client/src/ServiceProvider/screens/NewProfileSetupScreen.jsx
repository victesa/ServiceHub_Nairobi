...
function ServiceProviderNewProfileScreen({ nextScreen }) {
      ...
      <div style={{ padding: "20px", boxSizing: "border-box" }}>
        ...
        >
          ...
          <div style={{ marginBottom: "20px" }}>
            <label htmlFor="location" style={{ display: "block", marginBottom: "5px",  textAlign: "left" }}>Bio</label>
            <textarea
...
export default ServiceProviderNewProfileScreen;
